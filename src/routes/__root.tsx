...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Placement Spark" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@placementspark" },
    ],
    links: [
      {
        rel: "stylesheet",
    ...
    scripts: [
      { children: THEME_INIT_SCRIPT },
      {
        ...
        children: JSON.stringify({
          ...
          sameAs: ["https://linkedin.com/company/placement-spark", "https://instagram.com/placementspark"],
        }),
      },
    ],
  }),
